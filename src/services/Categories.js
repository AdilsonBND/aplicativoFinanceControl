...
export const getAllCategories = async () => {
  const querySnapshot = await firestore().collection('categories').orderBy('order').get()
...
export const getDebitCategories = async () => {
  const querySnapshot = await firestore().collection('categories').where('isDebit', '==', true).where('isInit', '==', false).orderBy('order').get()
...
export const getCreditCategories = async () => {
  const querySnapshot = await firestore().collection('categories').where('isCredit', '==', true).where('isInit', '==', false).orderBy('order').get()
...
export const getInitCategory = async () => {
  const querySnapshot = await firestore().collection('categories').where('isInit', '==', true).get()
